...
class SSEClient(object):
    def __init__(self, url, last_id=None, retry=30, session=None, chunk_size=1024, **kwargs):
        print('hallo')
        self.url = url
        ...
        self.requests_kwargs['headers']['Accept'] = 'application/json, text/plain, */*'#'text/event-stream'
