...
public class SerializableResourceImpl implements Resource, Serializable {
    ...
    public static String getLabel(Resource resource) {
        ...
        Platform.getLogger().log(resource.getClass(), "URI " + resource.getURI() + " now has label " + label);
        return label;
    }
...
//    private static class SerializedResource {
//
//        private String namespace;
//        private String localname;
//        private ModelCom model;
//        private AnonId anonId;
//
//        public SerializedResource(Resource resource) {
//            this.namespace = resource.getNameSpace();
//            this.localname = resource.getLocalName();
//            this.anonId = resource.getId();
//            anonId.getBlankNodeId().toString()
//            new AnonId();
//            new BlankNodeId()
//        }
//
